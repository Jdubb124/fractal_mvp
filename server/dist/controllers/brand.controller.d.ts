...
export declare const getBrandGuides: (req: Request<import("express-serve-static-core").ParamsDictionary, any, any, import("qs").ParsedQs, Record<string, any>>, res: Response<any, Record<string, any>>, next: import("express").NextFunction) => void;
...
export declare const getBrandContext: (userId: string, brandGuideId?: string) => Promise<import("../models/BrandGuide").IBrandGuideContext | null>;
